...
See below for a look at how the Hiletgo ESP32 board may connect to ESP-PROG:

<p align="center">
  <img src="img/fig1.png" height="300">
</p>

The purpose of this project is to show users how to pair the ESP32 development board with the ESP-PROG device and security implications of a JTAG interface on an IoT device. We will use Visual Studio Code and PlatformIO, which is a software plugin that enables app development on numerous IoT microcontrollers such as ESP32. Using VSCode and PlatformIO, we will download the project in this GitHub repository, load it into VS Code, compile it, upload it, and perform some debugging all through the ESP-PROG debugger board.
...
3. Download the source code of the project within a folder at the Ubuntu VM.


## Import, build and upload the project
4. Import the downloaded project into VS Code

Start VS Code -> *File* -> *Open Folder ...* -> [Navigate to the folder] -> *Ok*
...
Get the esp-idf environment in any terminal session, which is
...
<img src="https://user-images.githubusercontent.com/11084018/154603121-c4336640-edfa-46c5-853a-47a6528c0a07.png">
...
`~/esp-idf/examples/protocols/mqtt/tcp/build/gdbinit`

Note the contents of this file below:

```
file ~/esp-idf/examples/protocols/mqtt/tcp/build/mqtt_tcp.elf
target remote :3333
mon reset halt
flushregs
thb app_main
...
# Reference
[ESP32-With-ESP-PROG-Demo](https://github.com/PBearson/ESP32-With-ESP-PROG-Demo)
